export default function Sidebar() {
  return (
    <section className=" relative bg-gradient-to-r from-blue-900 to-blue-800 bg-opacity-50 sidebar z-20">
      ...
      <div className="side-cont h-full lg:h-screen flex lg:flex-col items-center justify-between select-none sticky w-full mx-auto top-0 lg:px-0 px-8 ">
        ...
        <h2 className="uppercase sm:tracking-[10px] lg:-rotate-90 font-semibold">
          Rajneeshzytox
        </h2>

        <label
          className="w-6 aspect-square ring rounded-full lg:my-6 flex items-center justify-center font-semiold italic text-white  cursor-pointer relative"
          htmlFor="my_modal_7"
        >
          <div
