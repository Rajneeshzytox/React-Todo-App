...
export default function Sidebar() {
    ...
    return(
      <section className=" relative sidebar ">
        <span className="glass pointer-events-none w-full h-full absolute"></span>
        <div className="side-cont h-full md:h-screen flex md:flex-col items-center justify-between select-none sticky w-full mx-auto top-0 md:px-0 px-8 ">
