    ...
    <footer className=" footer footer-center bg-base-300 text-bg-base-content py-10">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a
            className="hover:animate-bounce tooltip"
            data-tip="LinkedIn"
            href="https://linkedin.com/in/rajneeshzytox"
          >
            <svg
          ...
          <a
            className="hover:animate-bounce tooltip"
            href="https://x.com/rajneeshzytox"
            data-tip="twitter (X)"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            className="hover:animate-bounce tooltip"
            href="https://github.com/rajneeshzytox"
            data-tip="github"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            className="hover:animate-bounce tooltip"
            href="https://instagram.com/rajneeshzytox"
            data-tip="instagram"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
